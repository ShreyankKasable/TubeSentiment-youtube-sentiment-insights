...
@app.route('/')
def home():
    return "Welcome to our TubeSentiment-youtube-sentiment-insights"
...
def predict_with_timestamps():
    ...
    response = [{"comment": comment, "sentiment": sentiment, "timestamp": timestamp} for comment, sentiment, timestamp
...
def generate_wordcloud():
    try:
        ...
        # Preprocess comments
        preprocessed_comments = [preprocess_comment(comments) for comment in comments]
