...
file_handler = logging.FileHandler('logs/preprocessing_errors.log')
...
def normalize_text(df):
    ...
    try:
        ...
        logger.error(f"Error during test normalization: {e}")
        raise

def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    """Save the processed train and test dataset"""
    try:
